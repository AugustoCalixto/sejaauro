...
const paymentRates: Record<CardId, PaymentRate[]> = {
    visa: [
        ...
        { modalidade: 'Crédito à vista', taxa: { basic: 2.96 } },
        { modalidade: 'Parcelado 2x', taxa: { basic: 4.35 } },
        { modalidade: 'Parcelado 3x', taxa: { basic: 5.02 } },
        { modalidade: 'Parcelado 4x', taxa: { basic: 5.71 } },
        { modalidade: 'Parcelado 5x', taxa: { basic: 6.37 } },
        { modalidade: 'Parcelado 6x', taxa: { basic: 7.04 } },
        { modalidade: 'Parcelado 7x', taxa: { basic: 7.75 } },
        { modalidade: 'Parcelado 8x', taxa: { basic: 8.40 } },
        { modalidade: 'Parcelado 9x', taxa: { basic: 9.04 } },
        { modalidade: 'Parcelado 10x', taxa: { basic: 9.69 } },
        { modalidade: 'Parcelado 11x', taxa: { basic: 10.32 } },
        { modalidade: 'Parcelado 12x', taxa: { basic: 10.95 } },
        { modalidade: 'Parcelado 13x', taxa: { basic: 11.57 } },
        { modalidade: 'Parcelado 14x', taxa: { basic: 12.19 } },
        { modalidade: 'Parcelado 15x', taxa: { basic: 12.80 } },
        { modalidade: 'Parcelado 16x', taxa: { basic: 13.41 } },
        { modalidade: 'Parcelado 17x', taxa: { basic: 14.01 } },
        { modalidade: 'Parcelado 18x', taxa: { basic: 14.60 } },
    ],
    elo: [
        { modalidade: 'Débito', taxa: { basic: 1.45 } },
        { modalidade: 'Crédito à vista', taxa: { basic: 3.29 } },
        { modalidade: 'Parcelado 2x', taxa: { basic: 4.50 } },
        { modalidade: 'Parcelado 3x', taxa: { basic: 5.17 } },
        { modalidade: 'Parcelado 4x', taxa: { basic: 5.86 } },
        { modalidade: 'Parcelado 5x', taxa: { basic: 6.52 } },
        { modalidade: 'Parcelado 6x', taxa: { basic: 7.19 } },
        { modalidade: 'Parcelado 7x', taxa: { basic: 7.95 } },
        { modalidade: 'Parcelado 8x', taxa: { basic: 8.60 } },
        { modalidade: 'Parcelado 9x', taxa: { basic: 9.24 } },
        { modalidade: 'Parcelado 10x', taxa: { basic: 9.89 } },
        { modalidade: 'Parcelado 11x', taxa: { basic: 10.52 } },
        { modalidade: 'Parcelado 12x', taxa: { basic: 11.15 } },
        { modalidade: 'Parcelado 13x', taxa: { basic: 11.77 } },
        { modalidade: 'Parcelado 14x', taxa: { basic: 12.39 } },
        { modalidade: 'Parcelado 15x', taxa: { basic: 13.00 } },
        { modalidade: 'Parcelado 16x', taxa: { basic: 13.61 } },
        { modalidade: 'Parcelado 17x', taxa: { basic: 14.21 } },
        { modalidade: 'Parcelado 18x', taxa: { basic: 14.80 } },
    ],
    hiper: [
