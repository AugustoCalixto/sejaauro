...
const paymentRates: Record<CardId, PaymentRate[]> = {
    visa: [
        { modalidade: 'Débito', taxa: { basic: 0.99 } },
        { modalidade: 'Crédito à vista', taxa: { basic: 2.99 } },
        { modalidade: 'Parcelado 2x', taxa: { basic: 4.41 } },
        { modalidade: 'Parcelado 3x', taxa: { basic: 5.16 } },
        { modalidade: 'Parcelado 4x', taxa: { basic: 5.91 } },
        { modalidade: 'Parcelado 5x', taxa: { basic: 6.64 } },
        { modalidade: 'Parcelado 6x', taxa: { basic: 7.38 } },
        { modalidade: 'Parcelado 7x', taxa: { basic: 8.10 } },
        { modalidade: 'Parcelado 8x', taxa: { basic: 8.81 } },
        { modalidade: 'Parcelado 9x', taxa: { basic: 9.52 } },
        { modalidade: 'Parcelado 10x', taxa: { basic: 10.22 } },
        { modalidade: 'Parcelado 11x', taxa: { basic: 10.91 } },
        { modalidade: 'Parcelado 12x', taxa: { basic: 11.60 } },
        { modalidade: 'Parcelado 13x', taxa: { basic: 12.28 } },
        { modalidade: 'Parcelado 14x', taxa: { basic: 12.95 } },
        { modalidade: 'Parcelado 15x', taxa: { basic: 13.62 } },
        { modalidade: 'Parcelado 16x', taxa: { basic: 14.27 } },
        { modalidade: 'Parcelado 17x', taxa: { basic: 14.93 } },
        { modalidade: 'Parcelado 18x', taxa: { basic: 15.57 } },
    ],
    elo: [
        { modalidade: 'Débito', taxa: { basic: 1.15 } },
        { modalidade: 'Crédito à vista', taxa: { basic: 3.35 } },
        { modalidade: 'Parcelado 2x', taxa: { basic: 4.41 } },
        { modalidade: 'Parcelado 3x', taxa: { basic: 5.16 } },
        { modalidade: 'Parcelado 4x', taxa: { basic: 5.91 } },
        { modalidade: 'Parcelado 5x', taxa: { basic: 6.64 } },
        { modalidade: 'Parcelado 6x', taxa: { basic: 7.38 } },
        { modalidade: 'Parcelado 7x', taxa: { basic: 8.40 } },
        { modalidade: 'Parcelado 8x', taxa: { basic: 9.11 } },
        { modalidade: 'Parcelado 9x', taxa: { basic: 9.82 } },
        { modalidade: 'Parcelado 10x', taxa: { basic: 10.52 } },
        { modalidade: 'Parcelado 11x', taxa: { basic: 11.21 } },
        { modalidade: 'Parcelado 12x', taxa: { basic: 11.90 } },
        { modalidade: 'Parcelado 13x', taxa: { basic: 12.58 } },
        { modalidade: 'Parcelado 14x', taxa: { basic: 13.25 } },
        { modalidade: 'Parcelado 15x', taxa: { basic: 13.92 } },
        { modalidade: 'Parcelado 16x', taxa: { basic: 14.57 } },
        { modalidade: 'Parcelado 17x', taxa: { basic: 15.23 } },
        { modalidade: 'Parcelado 18x', taxa: { basic: 15.87 } },
    ],
    hiper: [
        { modalidade: 'Débito', taxa: { basic: 1.15 } },
        { modalidade: 'Crédito à vista', taxa: { basic: 3.79 } },
        { modalidade: 'Parcelado 2x', taxa: { basic: 4.41 } },
        { modalidade: 'Parcelado 3x', taxa: { basic: 5.16 } },
        { modalidade: 'Parcelado 4x', taxa: { basic: 5.91 } },
        { modalidade: 'Parcelado 5x', taxa: { basic: 6.64 } },
